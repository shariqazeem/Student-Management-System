...
def checkUsernameAndPassword(username_string, password_string):
    if username_string == "admin" and password_string == "password@123":
        return True
    else:
        return False
...
def login_button_click():
    if username.get() == "":
        ...
        window.destroy()
        import admin_home_screen
        obj = admin_home_screen
...
button_image_1 = PhotoImage(
    file=relative_to_assets("button_login_round_corner.png"))
button_1 = Button(
